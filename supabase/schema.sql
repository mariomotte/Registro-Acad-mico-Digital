...
CREATE TYPE app_role AS ENUM ('admin', 'director', 'subdirector', 'docente', 'auxiliar');
...
CREATE TABLE public.alumnos (
    ...
    dni TEXT UNIQUE CHECK (dni IS NULL OR length(dni) = 8),
...
CREATE TABLE public.incidencias (
    ...
    fecha_suceso TIMESTAMPTZ DEFAULT NOW(),
